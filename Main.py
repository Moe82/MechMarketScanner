...
class main:
	...
	def processKeywordString (self, string):
		...
		self.scanner.optionalKeywords = optionalKeywords
		self.scanner.nonOptionalKeywords = nonOptionalKeywords;

	def requestFlair(self):
		print("Would you like add flair? (press enter to search without flair)")
		flair = " "
		while flair not in ["buying","sellin","trading", ""]:
			flair = input("[buying/selling/trading]:")
		self.scanner.flair = flair 
	...
	def displayInstructions(self):
		...
		print("After you enter the keywords, you will have the option of picking 1 of 3 flairs:")
		print("\n\t-Buying\n\t-Selling\n\t-Trading")
		print("***********************************************************************************")
	...
	def requestOptionsForSettings(self):
			...
			print("\nWould you like to send a message to the author of posts that match your search term?")
	...
	def start(self):
		...
		while (self.settings.credentialsVerified != True):	
			...
			if self.scanner.isConnected(self.settings.getCredentialsDict()) == True:
